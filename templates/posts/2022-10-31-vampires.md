...
I once spent a month watching one Christmas movie per day to study the genre and I recently wanted to do it again with vampire movies, so I solicited recommendations from friends and Twitter and spent about five weeks watching 47 vampire movies. As a newly-minted vampire scholar, I'd like to show you some of the things I learned on this journey.

## A grand unified theory of vampires

My main goal was to come up with a unified theory of vampires. I went into this project familiar with the usual dollar-store-Halloween-costume-vampire tropes (pale, fangs, drinks blood, cape, etc.), but I was curious to see if these held up consistently as defining features of vampirism or if it was more complicated, and whether there were perhaps other things that were more important.

Thanks to the diversity of my recommendations (especially the TWENTY! recommendations from my friend Sy), it quickly became clear to me that there is no single feature that all vampires exhibit. Nope, not even blood-drinking. There's instead a constellation of vampiric features, some of which cluster into distinct subgenres like the Dracula/Orlok subgenre, the female temptress subgenre, the jiangshi (Chinese hopping vampire) subgenre, etc. There are also several films that exist in vampire space on their own, not as part of one of these recognizable subgenres. These typically contain characters that have a critical mass of some set of vampiric features, making them a vampire even if other features in the broader constellation are actively negated.

For example, Thirst (2009) is a Korean film that doesn't really fit into a pre-existing subgenre of vampire films. In this film, a priest participates in a clinical trial for a vaccine which fails, infecting him with a virus. This virus turns out to make him want to drink blood and have to stay out of sunlight, both of which are classical features that make this character a vampire, despite the fact that he remains visible in mirrors, contradicting another vampiric trope.
...
where 2 start. queer vampires, bisexual vampires, explicitly trans vampires, the kill all men trope, fear of the other once again, incel vampires, straight vampires, monogamous vampires, poly vampires
